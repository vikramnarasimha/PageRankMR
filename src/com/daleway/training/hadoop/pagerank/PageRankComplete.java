...
public class PageRankComplete {
	...
	public static class PageRankReducer extends
		...
		public void reduce(Text key, Iterable<Text> values,
			...
			double dnMass= Double.parseDouble(context.getConfiguration().get("dangling.node.mass"));
			//double pr = 0.85*1/75879 + 0.15*(dnMass/75879 + s);
			double pr = 0.15*1/75879 + 0.85*(dnMass/75879 + s);
			context.write(key, new Text(graph.toString()+ "\t" + new DecimalFormat("#.00000000").format(pr)));	
		}
	}
